...
class ResourceTask(Base):
    ...
    parent_resource_id: Mapped[str | None] = mapped_column(String(64), nullable=True, index=True)
    parent_source_resource_id: Mapped[str] = mapped_column(Text, nullable=False, default="")
    child_resource_ids_json: Mapped[str] = mapped_column(Text, nullable=False, default="[]")
    child_source_resource_ids_json: Mapped[str] = mapped_column(Text, nullable=False, default="[]")
    child_resource_count: Mapped[int] = mapped_column(Integer, nullable=False, default=0)
    contains_resource_types_json: Mapped[str] = mapped_column(Text, nullable=False, default="[]")
    download_object_key: Mapped[str] = mapped_column(Text, nullable=False, default="")
    download_file_name: Mapped[str] = mapped_column(Text, nullable=False, default="")
    download_content_type: Mapped[str] = mapped_column(String(128), nullable=False, default="")
    download_file_size: Mapped[int] = mapped_column(Integer, nullable=False, default=0)
