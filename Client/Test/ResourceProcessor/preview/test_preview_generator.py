...
from ResourceProcessor.core.resource_filter import PreviewGenerator
import subprocess
class TestPreviewGenerator(unittest.TestCase):
    ...
    @patch("ResourceProcessor.core.resource_filter.os.path.exists", return_value=True)
    @patch("ResourceProcessor.core.resource_filter.subprocess.run")
    ...
    @patch("ResourceProcessor.core.resource_filter.PreviewGenerator.generate_preview")
    @patch("os.makedirs")
