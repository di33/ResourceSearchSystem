param(
    [string]$DbPath = "G:\ResourceUpload\data\databases\pipeline_rebuilt_20260608_150207.db",
    [string]$LogDir = "",
...
$env:PYTHONPATH = "G:\ResourceUpload\client\Scripts"

if (-not $LogDir) {
    $stamp = Get-Date -Format "yyyyMMdd_HHmmss"
    $LogDir = "G:\ResourceUpload\data\logs\description_refresh_non_single_$stamp"
}
