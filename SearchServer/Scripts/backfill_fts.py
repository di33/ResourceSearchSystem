...
Usage:
    $env:PYTHONPATH="SearchServer"; python SearchServer/Scripts/backfill_fts.py           # fill NULLs only
    $env:PYTHONPATH="SearchServer"; python SearchServer/Scripts/backfill_fts.py --full     # recompute all rows
"""
